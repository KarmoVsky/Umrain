        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                @if(is_default_lang())
                    ...
                    <div class="form-group">
                        <label class="" >{{__("Layout Item Car In Page Search")}}</label>
                        <div class="form-controls">
                            <select name="car_layout_item_search" class="form-control" >
                                <option value="list" {{ ($settings['car_layout_item_search'] ?? '') == 'list' ? 'selected' : ''  }}>{{__("List Item")}}</option>
                                <option value="grid" {{($settings['car_layout_item_search'] ?? '') == 'grid' ? 'selected' : ''  }}>{{__('Grid Item')}}</option>
                            </select>
                        </div>
                    </div>
