<?php
    ...
    class TourController extends Controller
    {
        ...
        public function callAction($method, $parameters)
        {
            ...
            {
                $message = Module::where('name', 'tour')->first();
                if($message) {
        ...
        public function index(Request $request)
        {
            ...
            $layout_item = setting_item("tour_layout_item_search", 'grid');
            ...
            $locationsWithTours = $this->locationClass::with(['children' => function ($query) {
                $query->where('status', 'publish')
            ...
            $data = [
                ...
                'tour_location' => $listLocationWithTours,
