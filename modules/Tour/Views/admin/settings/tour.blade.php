    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="" >{{__("Layout Item Tour In Page Search")}}</label>
                    <div class="form-controls">
                        <select name="tour_layout_item_search" class="form-control" >
                            <option value="list" {{ ($settings['tour_layout_item_search'] ?? '') == 'list' ? 'selected' : ''  }}>{{__("List Item")}}</option>
                            <option value="grid" {{($settings['tour_layout_item_search'] ?? '') == 'grid' ? 'selected' : ''  }}>{{__('Grid Item')}}</option>
                        </select>
                    </div>
                </div>
