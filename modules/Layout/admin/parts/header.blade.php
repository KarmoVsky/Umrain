...
<div class="header-logo flex-shrink-0">
    <h3 class="logo-text">
        <a href="{{route('admin.index')}}">
            ...
            <span class="app-version"><img  width="60%" src="https://umrain.com/uploads/0000/7/2024/08/11/engligh-umrain-logo-white-200.jpg" alt="{{ config('app.name') }}" data-toggle="tooltip" data-placement="top" title="{{ config('app.name') }}"></span>
        </a>
    </h3>
</div>
