    ...
    public static function getAdminMenu()
    {
        ...
        $options = [
            ...
            'children'   => [
                ...
                'Permission'=>[
                    'url'        => route('user.admin.role.permission_matrix'),
                    'title'      => __('Permission Matrix'),
                    'permission' => 'user_view',
                ],
                'Configs'=>[
                    'url'        => route('user.admin.role.verifyFields'),
                    'title'      => __('Verify Configs'),
                    'permission' => 'user_view',
                ],
                /* 'userUpgradeRequest'=>[
        ...
        if(empty($is_disable_verification_feature)){
            $options['children']['user_verification'] = [
                ...
                'title'      => __('Verify Requests :count',['count'=>$noti_verify ? sprintf('<span class="badge badge-warning">%d</span>',$noti_verify) : '']),
                'permission' => 'user_view',
            ];
        }
