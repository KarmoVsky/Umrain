...
Route::get('/getForSelect2_hotel', 'UserController@getForSelect2_hotel')->name('user.admin.getForSelect2_hotel');
...
Route::group(['prefix' => 'vendor'], function () {
    Route::get('/index', 'VendorController@index')->name('user.admin.vendor.index');
    Route::post('/userAddBusinessApproved', 'VendorController@userAddBusinessApproved')->name('user.admin.business.approved');
    Route::get('/userAddBusinessApprovedId/{id}', 'VendorController@userAddBusinessApprovedId')->name('user.admin.business.approvedId');
    Route::post('/userAddBusinessApprovedId2', 'VendorController@userAddBusinessApprovedId2')->name('user.admin.business.approvedId2');
    Route::get('/business/{id}', 'VendorController@getBusinessById')->name('user.admin.business.getById');
});
