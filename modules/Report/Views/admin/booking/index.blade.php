                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>{{__("Total")}} : {{format_money_main($row->total)}}<br/>
                                    ...
                                    {{__("Status")}} : {{$row->invoice_status ?? ''}}<br/>
                                </td>
                                <td>
                                ...
                                <td>
                                    {{-- {{$row->gatewayObj ? $gateway = $row->gatewayObj->getDisplayName() : ''}} --}}
                                    @php $row->gatewayObj ? $gateway = $row->gatewayObj->getDisplayName() : $gateway = '' @endphp
                                    @if($row->gateway == 'myfatoorah' && $row->payment_gateway != null)
                                        {{ $row->payment_gateway }}
                                    @else
                                        {{ $gateway }}
                                    @endif
