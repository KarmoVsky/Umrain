...
$rtl = $lang === 'ar' ? 'rtl' : ''; // Check if the language is Arabic
?>
<div class="panel {{$rtl}}">
        ...
        <div class="seo-preview max-w-650">
            ...
            <div>
                <div class="seo-title text-20 mb-2">
                    <span class="val">{{ $meta_seo['seo_title'] ?? $meta_seo['service_title'] ?? $row->title ?? $row->name ?? 'No Title Available' }}</span>
                </div>
                    ...
                    <div class="tab-pane active" id="seo_1">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="seo_title"
                                class="form-control"
                                placeholder="{{ $meta_seo['seo_title'] ?? $meta_seo['service_title'] ?? $row->title ?? $row->name ??  __("Leave blank to use service title") }}"
