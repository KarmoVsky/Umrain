    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__("Other color")}}</label>
                        <div class="form-controls">
                            <input type="text" name="style_other_color" value="{{setting_item('style_other_color','#1a2b48')}}" class="has-colorpicker d-none">
                        </div>
                    </div>
                </div>
                @endif
                ...
                <div class="col-sm-13">
                    <div class="panel">
                        <div class="panel-title"><strong>{{__('Button color')}}</strong></div>
                        <div class="panel-body">
                            <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                <label>{{__("Primary")}}</label>
                                    <div class="form-controls">
                                    <input type="text" name="style_btn_primary_color" value="{{setting_item('style_btn_primary_color','#0d6efd')}}" class="has-colorpicker d-none">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-controls">
                                    <input type="text" name="style_btn_secondary_color" value="{{setting_item('style_btn_secondary_color','#6c757d')}}" class="has-colorpicker d-none">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                <label>{{__("Danger")}}</label>
                                    <div class="form-controls">
                                    <input type="text" name="style_btn_danger_color" value="{{setting_item('style_btn_danger_color','#dc3545')}}" class="has-colorpicker d-none">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{__("Info")}}</label>
                                    <div class="form-controls">
                                    <input type="text" name="style_btn_info_color" value="{{setting_item('style_btn_info_color','#0dcaf0')}}" class="has-colorpicker d-none">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{__("Warning")}}</label>
                                    <div class="form-controls">
                                    <input type="text" name="style_btn_warning_color" value="{{setting_item('style_btn_warning_color','#ffc107')}}" class="has-colorpicker d-none">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{__("Success")}}</label>
                                    <div class="form-controls">
                                    <input type="text" name="style_btn_success_color" value="{{setting_item('style_btn_success_color','#198754')}}" class="has-colorpicker d-none">
                                    </div>
                                </div>
                            </div>
                            <!-- زر إعادة الافتراضي -->
                            <div class="col-md-12 text-center">
                                <button type="button" id="reset-defaults" class="btn btn-warning">
                                    {{__('Reset to Default')}}
                                </button>
                            </div>
                            </div>
...
<script>
    document.getElementById('reset-defaults').addEventListener('click', function () {
        ...
        const defaultColors = {
            "style_btn_primary_color": "#0d6efd",
            "style_btn_secondary_color": "#6c757d",
            "style_btn_danger_color": "#dc3545",
            "style_btn_info_color": "#0dcaf0",
            "style_btn_warning_color": "#ffc107",
            "style_btn_success_color": "#198754",
            "style_main_color": "#5191FA",
            "style_other_color": "#1a2b48",
        };
        ...
        for (let key in defaultColors) {
            ...
            if (inputField) {
                ...
                inputField.value = defaultColors[key];


                if ($(inputField).hasClass('has-colorpicker')) {
                    $(inputField).spectrum("set", defaultColors[key]);
                }


                if (typeof $(inputField).trigger === 'function') {
