@if (is_default_lang())
    <div class="panel">
        <div class="panel-title"><strong>{{ __('Minimum Booking Conditions') }}</strong></div> <!-- Renamed the panel -->
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label>{{ __('Minimum advance reservations') }}</label>
                        <input type="number" name="min_day_before_booking" class="form-control"
                            value="{{ $row->min_day_before_booking }}" placeholder="{{ __(' ') }}">
                        <i>{{ __('Leave blank if you dont need to use the min day option') }}</i>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label>{{ __('Minimum day stay requirements') }}</label>
                        <input type="number" name="min_day_stays" class="form-control"
                            value="{{ $row->min_day_stays }}" placeholder="{{ __(' ') }}">
                        <i>{{ __('Leave blank if you dont need to set minimum day stay option') }}</i>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label>{{ __('Use Minimum number of booking guests') }}</label>
                        <input type="number" name="minimum_guests" class="form-control"
                            value="{{ $row->minimum_guests }}" placeholder="{{ __(' ') }}">
                        <i>{{ __("Leave it blank if you don't want to set a minimum guest requirement.") }}</i>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label>{{ __('Use Minimum booking amount') }}</label>
                        <input type="number" name="minimum_amount" class="form-control"
                            value="{{ $row->minimum_amount }}" placeholder="{{ __(' ') }}">
                        <i>{{ __('Leave it blank if you do not want to set a minimum total amount condition.') }}</i>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <input type="checkbox" name="condition_type" id="check_guests"
                            @if (old('condition_type', $row->condition_type) === 'on') checked @endif>
                        <label for="check_guests">{{ __('Select here to activate both conditions together.') }}</label>
                        <br />
                        <i>{{ __('Both conditions will be applied if checked.') }}</i>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="panel-body">
                ...
                <div class="form-group @if (!is_default_lang()) d-none @endif">
                    <label><input type="checkbox" name="enable_extra_price"
                            @if (!empty($row->enable_extra_price)) checked @endif value="1">
                            ...
                            <div class="item" data-number="{{ $key }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <label>
                                            <input type="checkbox" min="0"
                                                name="service_fee[{{ $key }}][per_person]" value="on"
                ...
                <div class="g-more hide">
                    <div class="item" data-number="__number__">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input type="number" min="0" step="0.1"
                                    __name__="service_fee[__number__][price]" class="form-control" value="">
