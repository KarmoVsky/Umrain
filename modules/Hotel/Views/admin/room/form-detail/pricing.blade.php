@if(is_default_lang())
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <h8>{{__("Bed wide size:")}}</h8>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label>{{__("from")}} </label>
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="bed_width_from" value="{{$row->bed_width_from ?? 0}}" placeholder="{{__("from")}}" >
                    <div class="input-group-append">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label>{{__("to")}} </label>
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="bed_width_to" value="{{$row->bed_width_to ?? 0}}" placeholder="{{__("to")}}" >
                    <div class="input-group-append">
                        <span class="input-group-text" >cm</span>
                    </div>
                </div>
