...
Route::get('/acceptVendor/{id}/{status}','HotelController@acceptVendor')->name('hotel.admin.accept_vendor');
...
Route::post('/updateGalleryOrder/{id}', 'HotelController@updateGalleryOrder')->name('hotel.admin.updateGalleryOrder');

Route::get('/getVendorsForSelect2', 'HotelController@getVendorsForSelect2')->name('hotel.admin.getVendorsForSelect2');
