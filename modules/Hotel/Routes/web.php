...
// use Modules\User\Controllers\ManageUserController;
...
Route::group(['prefix' => 'user/' . config('hotel.hotel_route_prefix'), 'middleware' => ['auth', 'verified', 'service.approval:hotel']], function () {
    ...
    Route::post('/cancel/{id}', 'VendorController@cancelHotel')->name('hotel.vendor.cancel');
    ...
    Route::get('/search', 'VendorController@search')->name('hotel.vendor.search');
    Route::post('/addHotel', 'VendorController@addHotel')->name('hotel.vendor.add');
