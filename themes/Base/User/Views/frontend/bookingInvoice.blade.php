    ...
    <script type="text/javascript">
        ...
        window.onload = function() {
            if (!isMobile()) {
                ...
                console.log('Printing is disabled on mobile devices.');
            }
        };
    </script>

    <div id="invoice-print-zone">
        <table class="ml-sm-5 mr-sm-5" width="" cellspacing="0" cellpadding="0">
            <thead>
            <tr>
                <th width="70%">
        ...
        <hr>
        {{-- This section is displayed in all invoices except the hotel --}}
        ...
        <hr>
        @endif
        @if(!empty($service->invoice_new_booking_file))
            <div class="email_new_booking  ml-3 ml-sm-5 mr-3 mr-sm-5 d-fle flex-colum align-items-center justify-content-cente" style="width: 85;">
                @include($service->invoice_new_booking_file ?? '')
            </div>
        @endif
    </div>
@endpush
