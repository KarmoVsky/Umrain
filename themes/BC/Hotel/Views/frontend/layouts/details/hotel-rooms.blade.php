                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-3">
                                ...
                                <div class="modal" :id="'modal_room_'+room.id" tabindex="-1" role="dialog">
                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document" style="max-width: 90%; max-height: 90vh;">
                                                    ...
                                                    <div class="col-lg-5 order-lg-1">
                                                        <div class="list-attributes">
                                                            <div class="attribute-item" v-for="term in room.terms">
                                                                ...
                                                                <ul v-if="term.child" class="row m-0">
                                                                    <li v-for="term_child in term.child" class="col-lg-6 col-md-4 text-nowrap m-0 mb-3">
                            ...
                            <div class="col-md-3" v-if="room.number">
                                <div class="col-price clear">
                                    <div class="text-center">
                                        <span dir="{{(app()->getLocale() == 'en')? 'ltr' : 'rtl'}}" class="price" v-html="room.price_html"></span>
                                    </div>
                                    <select v-if="room.number" v-model="room.number_selected" class="custom-select">
                                        <option value="0">0</option>
                                        <option v-for="i in (1,room.number)" :value="i">@{{i+' '+ (i > 1 ? i18n.rooms  : i18n.room)}} &nbsp;&nbsp; (@{{formatMoney(i*room.price + room.commissionperdayandperson)}})</option>
                                    </select>
                                </div>
                            </div>
                        </div>
