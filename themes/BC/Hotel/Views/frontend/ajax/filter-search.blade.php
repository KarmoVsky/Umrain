<div class="bravo_filter">
    <form action="{{ route('hotel.search') }}" class="bravo_form_filter">
        ...
        <div class="ajax-star-filter">
            @include('Hotel::frontend.ajax.star-filter')
        </div>


        <div class="ajax.review-score-filter">
            @include('Hotel::frontend.ajax.review-score-filter')
        </div>

        <div class="ajax.term-filter">
            @include('Hotel::frontend.ajax.term-filter')
        </div>
