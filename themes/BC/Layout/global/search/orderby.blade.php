@php
    // تحقق من مسار الصفحة الحالي
    $currentUrl = url()->current();
    $isHotelPage = strpos($currentUrl, '/hotel') !== false;

    // تغيير $routeName بناءً على الصفحة الحالية
    $routeName = $isHotelPage ? 'hotel.search' : $routeName;
@endphp
