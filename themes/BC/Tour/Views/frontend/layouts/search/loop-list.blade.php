...
<div class="item-tour item-loop-wrap {{$wrap_class ?? ''}}">
    ...
    @endif
    <div class="row align-items-center"> <!-- نستخدم العرض الكامل مع تقسيم الـ row -->
        <div class="col-md-4">
        ...
        <div class="col-md-8"> <!-- معلومات التور في القسم الآخر -->
            <div class="location">
...
{{-- @php
    $translation = $row->translate();
@endphp
<div class="card item-tour item-loop-list item-loop-wrap {{$wrap_class ?? ''}}">
    @if($row->is_featured == "1")
        <div class="featured">
            {{__("Featured")}}
        </div>
